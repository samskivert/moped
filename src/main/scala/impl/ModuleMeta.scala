...
// /** Contains additional metadata for a Moped package module. This metadata is extracted from
...
//     val ents = jfile.entries()
//     while (ents.hasMoreElements()) {
//       val jentry = ents.nextElement() ; val fn = apply(jentry.getName)
//       if (fn != null) {
...
//     override def visitEnd () :Unit = {
//       _anns.get("Lmoped/Major;") foreach { attrs =>
...
//       }
//       _anns.get("Lmoped/Minor;") foreach { attrs =>
//         val mode = attrs.get("name").iterator.next
...
//     override def visitEnd () :Unit = {
//       _anns.get("Lmoped/Service;") foreach { attrs =>
...
//     override def visitEnd () :Unit = {
//       _anns.get("Lmoped/Plugin;") foreach { attrs =>
