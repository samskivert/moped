...
package moped.markdown

import moped._
import moped.grammar._
import moped.Matcher
import moped.util.{Filler, Paragrapher}

@Plugin
class MarkdownGrammarPlugin extends GrammarPlugin {
  import EditorConfig._
  import moped.major.TextConfig._

  override def grammars = Map("text.html.markdown" -> "grammar/Markdown.ndf")
