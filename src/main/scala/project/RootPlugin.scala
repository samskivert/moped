...
/** Used by the project system to identify project roots. */
...
@Plugin class GitRootPlugin extends RootPlugin.Directory(".git")

/** Roots projects at .hg directories. */
@Plugin class MercurialRootPlugin extends RootPlugin.Directory(".hg")

/** Roots projects at the highest .svn directory. */
@Plugin class SubversionRootPlugin extends RootPlugin {
